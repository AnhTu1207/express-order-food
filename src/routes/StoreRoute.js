...
const { AddStoreRequest, LoginStoreRequest, UpdateStoreRequest, UpdateStorePasswordRequest } = require(appRoot + "/requests");
...
router.put("/update-password/:id", [StoreAuth, UpdateStorePasswordRequest], StoreController.updatePassword)
