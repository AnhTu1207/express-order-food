...
const { UpdateStatusRequest, AddDriverRequest, UpdateDriverRequest, LoginRequest, UpdatePasswordRequest, ResendEmailRequest } = require(appRoot + "/requests");
...
router.get("/showTopDriver", AdminAuth, DriverController.showTopDriver);
...
router.put("/update-status/:id", [AdminAuth, UpdateStatusRequest], DriverController.updateStatus);
